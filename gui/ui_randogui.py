...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_item_type_select_label = QLabel(self.tab_cosmetics)
        self.label_item_type_select_label.setObjectName(u"label_item_type_select_label")

        self.hlay_type_options.addWidget(self.label_item_type_select_label)

        self.item_type_select = QComboBox(self.tab_cosmetics)
        self.item_type_select.setObjectName(u"item_type_select")
        sizePolicy10.setHeightForWidth(self.item_type_select.sizePolicy().hasHeightForWidth())
        self.item_type_select.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHorizontalStretch(17)
        ...
        sizePolicy10.setHeightForWidth(self.option_model_pack_select.sizePolicy().hasHeightForWidth())
        self.option_model_pack_select.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.button_randomize_all_colors.sizePolicy().hasHeightForWidth())
        self.button_randomize_all_colors.setSizePolicy(sizePolicy10)
        ...
        sizePolicy10.setHeightForWidth(self.button_reset_all_colors.sizePolicy().hasHeightForWidth())
        self.button_reset_all_colors.setSizePolicy(sizePolicy10)
        ...
        sizePolicy13.setHeightForWidth(self.color_presets_list.sizePolicy().hasHeightForWidth())
        self.color_presets_list.setSizePolicy(sizePolicy13)
...
"-->", None))
        ...
        self.label_item_type_select_label.setText(QCoreApplication.translate("MainWindow", u"Item", None))
